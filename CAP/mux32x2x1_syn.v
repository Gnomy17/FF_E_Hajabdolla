...
//lpm_mux DEVICE_FAMILY="Stratix II" LPM_SIZE=2 LPM_WIDTH=32 LPM_WIDTHS=1 data result sel
...
module mux32x2x1 (
	...
	mux32x2x1_mux	mux32x2x1_mux_component (
				.sel (sub_wire2),
				.data (sub_wire4),
				.result (sub_wire0));
